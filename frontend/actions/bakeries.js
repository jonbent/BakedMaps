...
export const fetchBakeriesFromFollowings = (followings) => dispatch => {
    return WMApiUtil.fetchBakeriesFromFollowings(followings).then(bakeries => dispatch(receiveBakeries({data: {listings: bakeries}})))
}